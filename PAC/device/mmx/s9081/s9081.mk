...
# Sensors
PRODUCT_COPY_FILES += \
    vendor/mmx/s9081/files/lib/hw/sensors.mt6577.so:system/lib/hw/sensors.mt6577.so \
...
# RIL
PRODUCT_COPY_FILES += \
    device/mmx/s9081/files/lib/mtk-ril.so:system/lib/mtk-ril.so \
    device/mmx/s9081/files/lib/mtk-ril3.so:system/lib/mtk-ril3.so \
    device/mmx/s9081/files/lib/librilmtk.so:system/lib/librilmtk.so \
    device/mmx/s9081/files/lib/libril3mtk.so:system/lib/libril3mtk.so
    
 
# Bluetooth
PRODUCT_COPY_FILES += \
    device/mmx/s9081/files/lib/libmtka2dp.so:system/lib/libmtka2dp.so \
